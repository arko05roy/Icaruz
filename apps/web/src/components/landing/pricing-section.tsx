...
const TIERS: Tier[] = [
  {
    ...
    period: "/ MIT license",
    tag: null,
    description: "Run Icaruz locally. Bring your own BTL workspace key.",
    features: [
      { text: "Full source access", included: true },
      { text: "Local specialist brains", included: true },
      { text: "Mixture + brain APIs", included: true },
      { text: "BTL economics ledger", included: true },
      { text: "Managed gateway", included: false },
      { text: "Dedicated support", included: false },
    ],
    cta: "VIEW ON GITHUB",
    href: "https://github.com/arko05roy/Icaruz",
    external: true,
    highlighted: false,
  },
  {
    ...
    name: "BTL_GATEWAY",
    price: "usage",
    period: "/ per inference",
    tag: "RECOMMENDED",
    description: "Production mixture queries through BTL Runtime with prefix cache.",
    features: [
      { text: "Pay per BTL inference", included: true },
      { text: "Prefix cache + dedupe", included: true },
      { text: "btl-2 router + synthesis", included: true },
      { text: "Live economics receipt", included: true },
      { text: "Quote API (?quote=1)", included: true },
      { text: "Custom vault hosting", included: false },
    ],
    cta: "OPEN APP",
    href: "/ask",
    highlighted: true,
  },
  {
    ...
    period: "",
    tag: null,
    description: "Private knowledge vaults, custom brains, and dedicated deployment.",
    features: [
      { text: "Custom specialist brains", included: true },
      { text: "Private wiki compilation", included: true },
      { text: "On-prem brain service", included: true },
      { text: "MCP server integration", included: true },
      { text: "SLA + dedicated support", included: true },
      { text: "Volume pricing via BTL", included: true },
    ],
    cta: "CONTACT US",
    href: "https://github.com/arko05roy/Icaruz/issues",
    external: true,
    highlighted: false,
  },
]
...
function PricingCard({ tier, index }: { tier: Tier; index: number }) {
  ...
  const isUsage = tier.price === "usage"
      ...
      <div className="px-5 pt-6 pb-4">
        <div className="flex items-baseline gap-1">
          {isCustom ? (
            ...
            <span className="text-3xl lg:text-4xl font-mono font-bold tracking-tight uppercase">Usage</span>
          ) : (
...
export function PricingSection() {
  return (
    <section id="pricing" className="w-full px-6 py-20 lg:px-12 scroll-mt-24">
      {/* Section label */}
      <motion.div
      ...
      >
        <div className="flex flex-col gap-3">
          <h2 className="text-2xl lg:text-3xl font-mono font-bold tracking-tight uppercase text-foreground text-balance">
            Choose how you run mixture-of-brains
          </h2>
          <p className="text-xs lg:text-sm font-mono text-muted-foreground leading-relaxed max-w-md">
            Self-host the stack, route through BTL Runtime, or deploy private specialist
            vaults with enterprise support.
          </p>
        </div>
        <StatusLine />
      </motion.div>
      ...
      >
        <span className="text-[10px] tracking-[0.2em] uppercase text-muted-foreground font-mono">
          {"* Inference billed by BTL Runtime. Icaruz is MIT-licensed. No vendor lock-in."}
        </span>
        <div className="flex-1 border-t border-border" />
      </motion.div>
    </section>
