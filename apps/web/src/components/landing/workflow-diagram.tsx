...
const LEFT_LABELS = ["Ask", "Match", "Read"]
const RIGHT_LABELS = ["Consult", "Merge", "Answer"]
  ...
  return (
    <div className="relative w-full max-w-[800px] mx-auto">
      <svg
        ...
        role="img"
        aria-label="How Icaruz works: ask a question, match specialist brains, read their knowledge, consult them in parallel, merge answers, deliver one response"
      >
