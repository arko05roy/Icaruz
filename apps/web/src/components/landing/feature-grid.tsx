...
import { DitherCard } from "@/components/landing/bento/dither-card"
import { MetricsCard } from "@/components/landing/bento/metrics-card"
...
export function FeatureGrid() {
  return (
    <section id="how-it-works" className="w-full px-6 py-20 lg:px-12 scroll-mt-24">
      {/* Section label */}
      <motion.div
